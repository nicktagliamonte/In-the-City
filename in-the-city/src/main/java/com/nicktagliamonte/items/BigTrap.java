...
public class BigTrap extends Trap {
    @Expose private static final int DURATION = 100;
    @Expose private static final int INTERVAL = 1000;
    @Expose private static final double SUCCESS_RATE = 0.80;
    ...
    public BigTrap(GameState gameState) {
        super("Big Trap", "A big trap. Good for finding supplies.", 8, true, 8, gameState);
    ...
    public BigTrap() {
        super("Big Trap", "A big trap. Good for finding supplies.", 8, true, 8);
        Map<Item, Integer> cost = new HashMap<Item, Integer>();
        cost.put(new Scrap(), 2);
        cost.put(new FoodRation(), 1);
        cost.put(new FuelCell(), 1);
    ...
    public String toSerializableFormat() {
        ...
        jsonObject.addProperty("type", "Big Trap");
