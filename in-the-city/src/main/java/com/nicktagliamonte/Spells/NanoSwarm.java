...
public class NanoSwarm extends Spell {
    @Expose private int dieQuantity = 4;
    @Expose private int dieFaces = 8;

    public NanoSwarm() {
        super("Nano Swarm", "Releases a swarm of nanobots that attack a single enemy, tearing and corroding them.", "4d8");
    }
    ...
    public String toSerializableFormat() {
        ...
        jsonObject.addProperty("type", "NanoSwarm");
